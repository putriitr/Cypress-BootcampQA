...
// POM
/// <reference types="cypress" />
import invalidUsername from '../support/page_objects/InvalidUsername';
...
describe('Login Feature - Invalid Username', () => {
  ...
  it('Pengguna tidak dapat login dengan data tidak valid (username salah & password benar)', () => {
    invalidUsername.visitLoginPage();

    invalidUsername.enterUsername('WrongUser');
    invalidUsername.enterPassword('admin123');

    invalidUsername.clickLoginButton();
    ...
    invalidUsername.verifyErrorMessage('Invalid credentials');
  });
});
